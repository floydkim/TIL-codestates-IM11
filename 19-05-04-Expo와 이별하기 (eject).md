...
다만 EXPO 앱은 네이티브 앱이라서 OS 레이어와 상호작용을 대신 합니다. 그리고 코드를 작성할 때 컴포넌트화내장된 네이티브 모듈들을 이용할 수 있기 때문에 단순한 웹뷰 수준을 벗어나서 네이티브한 기능을 구현할 수 있습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTMzMzQ0MzgyLDE2MTQwMzU4MDgsLTE0MD
c3NzM2NjQsLTE2ODA4MjU2OTFdfQ==
-->
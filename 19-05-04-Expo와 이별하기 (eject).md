...
반면에 우리가 작성한 자바스크립트 코드는 EXPO 모바일 클라이언트 안에서만 동작하고, 자바스크립트 엔진으로만 동작하기 때문에 네이티브 언어 라이브러리를 소화해 낼 수 없습니다.
다만 EXPO에 내장된 네이티브 모듈들을 이용할 수 있기 때문에 단순한 웹뷰 수준을 벗어나서 네이티브한 기능을 구현할 수 있습니다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMjc3MzY5NzAsMTYxNDAzNTgwOCwtMT
QwNzc3MzY2NCwtMTY4MDgyNTY5MV19
-->
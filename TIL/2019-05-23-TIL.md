...
z에서 a로 다시 넘어오는 loop이 발생하는 경우를 나머지 연산자로 처리하고 나니 0~25의 인덱스 형태가 리턴되어 이것을 약간의 인력을 들여 알charCode를 문자열로 다시 변환할 때
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUyMzMzMTQ5NiwtMTEyMjk2MDYwOSwtMT
